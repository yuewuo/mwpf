...
pub struct OutputSubgraph {
    ...
    internal_subgraph: InternalSubgraph, // for internal use only, not exposed to users
}
...
// TODO: double check if we should comment this out
